    ...
    <main className="mx-auto max-w-7xl md:p-10">
      ...
      {files && files?.length !== 0 ? (
          ...
          {files
            ...
            .map((file) => {
              return (
                <li
                  key={file.id}
                  className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white hover:shadow-lg"
                >
                  <Link
                  ...
                  <div className="px-4 mt-4 grid grid-cols-3 place-items-center py-2 gap-4 text-xs text-zinc-500">
        ...
        <div className="mt-16 flex flex-col items-center gap-2">
          ...
          <h1 className="text-xl font-semibold">Not files found...</h1>
          <p>Let&apos;s upload your file</p>
        </div>
      )}
    </main>
  );
